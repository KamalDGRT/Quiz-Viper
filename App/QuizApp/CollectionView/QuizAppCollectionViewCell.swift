//
//  QuizAppCollectionViewCell.swift
//  QuizApp
//
...
class QuizAppCollectionViewCell: UICollectionViewCell {
    
    @IBOutlet weak var questionLabel: UILabel!
    
    //    These are done for the text on the Square Cell
    //    a.k.a Collection View Cell
    @IBOutlet weak var option1: UILabel!
    @IBOutlet weak var option2: UILabel!
    @IBOutlet weak var option3: UILabel!
    @IBOutlet weak var option4: UILabel!
    
    //    These are done for the Square Cell Views
    ...
    //    Added to remove the border on all 4 views when new question loads
